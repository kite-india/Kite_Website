...
const Activities: React.FC<ActivityProps> = ({ data,addToCartHandler,updateTotalCost }) => {
  console.log(data)
  return (
            ...
            return (
              <SwiperSlide key={activity.name}>
                <Flex direction="column" gap={4} mb={4}>
                  <ActivityCard updateTotalCost={updateTotalCost} addToCartHandler={addToCartHandler} data={activity} />
