...
import { GetPackageQuery, CreateRegistrationMutation, GetPackageQueryVariables, ActivitiesByPackageIDQuery } from 'src/API'
      ...
      <Container w="100%" pt={8} maxWidth="container.xl">
        ...
        <Box mt={12} maxW="container.xl">
          <Section delay={0.3}>
            ...
            <Box mt={20}>
              <Section delay={0.4} >
                <Activities updateTotalCost={updateTotalCost} addToCartHandler={addToCartHandler} data={activities} />
              </Section>
            </Box>
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  ...
  try {
    ...
    const getActivities = await API.graphql<GraphQLQuery<ActivitiesByPackageIDQuery>>({
