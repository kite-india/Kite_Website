...
import { GetPackageQuery, GetRegistrationQuery, RegistrationsByUserinfoIDQuery, } from 'src/API'
...
const Transactions: NextPage = (props: any) => {
  ...
  useEffect(() => {
    ...
    const cancel = props.transaction.filter(pkg => pkg.bookingStatus === "canceled")
    const booked = props.transaction.filter(pkg => pkg.bookingStatus === "Booked")
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  ...
  try {
    ...
    console.log(user)
    const data = await cAPI.graphql<GraphQLQuery<RegistrationsByUserinfoIDQuery>>({
      query: `
      query MyQuery {
