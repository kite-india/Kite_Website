...
const Login: NextPage = () => {
  ...
  return (
    <Layout title="Login">
      ...
      >
        <Section delay={0.2}>
          {!confirmation && <><Flex direction="column" gap="3">
            <Heading
              textAlign="center"
              fontFamily="'Poppins'"
              fontWeight="600"
          ...
          </Flex><Text mt="20px" textAlign="center">
              Or
            </Text><Flex px={{ base: 2, lg: '50px' }} flexDirection="column" gap="9px">
          ...
          {confirmation && <Verification username={loginParams.email}></Verification>}
        </Section>
      </Container>
    </Layout>
  )
