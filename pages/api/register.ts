...
//   const accessToken =
//     req.cookies[
//       'CognitoIdentityServiceProvider.17ovl7a0e00fsg578kopumaho2.fced523e-6617-4654-bdc9-c6ecff8fe656.accessToken'
//     ]
...
//     const param = {
//       FilterExpression:
//         'registrationPackageId = :topic AND userinfoID = :userInfoId',
...
//     if (
//       checkPackageIsAlreadyReg.Items.length > 0 &&
//       checkPackageIsAlreadyReg.Items[0].bookingStatus.S === 'Booked'
//     ) {
//       res
//         .status(200)
//         .json({
//           status: false,
//           message: 'Your already registered this package'
//         })
//       return
//     }
...
//     if (extraPassenger) {
//       const isExtraPassengerValid =
//         extraPassengerArrayScehma.safeParse(extraPassenger)

//       if (!isExtraPassengerValid.success) {
//         res
//           .status(200)
//           .json({ status: false, message: 'Please fill all required fields' })
//         return
//       }
