...
export declare type Enquiry = LazyLoading extends LazyLoadingDisabled
  ? EagerEnquiry
  : LazyEnquiry
...
export declare const Enquiry: (new (init: ModelInit<Enquiry>) => Enquiry) & {
  copyOf(
    source: Enquiry,
    mutator: (draft: MutableModel<Enquiry>) => MutableModel<Enquiry> | void
  ): Enquiry
}
...
export declare type Gallery = LazyLoading extends LazyLoadingDisabled
  ? EagerGallery
  : LazyGallery
...
export declare const Gallery: (new (init: ModelInit<Gallery>) => Gallery) & {
  copyOf(
    source: Gallery,
    mutator: (draft: MutableModel<Gallery>) => MutableModel<Gallery> | void
  ): Gallery
}
...
export declare type Registration = LazyLoading extends LazyLoadingDisabled
  ? EagerRegistration
  : LazyRegistration

export declare const Registration: (new (
  init: ModelInit<Registration>
) => Registration) & {
  copyOf(
    source: Registration,
    mutator: (
      draft: MutableModel<Registration>
    ) => MutableModel<Registration> | void
  ): Registration
}
...
export declare type Review = LazyLoading extends LazyLoadingDisabled
  ? EagerReview
  : LazyReview
...
export declare const Review: (new (init: ModelInit<Review>) => Review) & {
  copyOf(
    source: Review,
    mutator: (draft: MutableModel<Review>) => MutableModel<Review> | void
  ): Review
}
...
export declare type Package = LazyLoading extends LazyLoadingDisabled
  ? EagerPackage
  : LazyPackage
...
export declare const Package: (new (init: ModelInit<Package>) => Package) & {
  copyOf(
    source: Package,
    mutator: (draft: MutableModel<Package>) => MutableModel<Package> | void
  ): Package
}
...
export declare type UserInfo = LazyLoading extends LazyLoadingDisabled
  ? EagerUserInfo
  : LazyUserInfo
...
export declare const UserInfo: (new (init: ModelInit<UserInfo>) => UserInfo) & {
  copyOf(
    source: UserInfo,
    mutator: (draft: MutableModel<UserInfo>) => MutableModel<UserInfo> | void
  ): UserInfo
}
