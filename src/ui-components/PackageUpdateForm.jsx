...
export default function PackageUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setActual_cost(cleanValues.actual_cost);
    setHave_flight(cleanValues.have_flight);
    setHave_hotels(cleanValues.have_hotels);
    setHave_sightseeing(cleanValues.have_sightseeing);
    setHave_meals(cleanValues.have_meals);
    setHave_transfers(cleanValues.have_transfers);
