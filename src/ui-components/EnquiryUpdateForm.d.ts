...
export declare type EnquiryUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    enquiry?: Enquiry;
    onSubmit?: (fields: EnquiryUpdateFormInputValues) => EnquiryUpdateFormInputValues;
    onSuccess?: (fields: EnquiryUpdateFormInputValues) => void;
    onError?: (fields: EnquiryUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: EnquiryUpdateFormInputValues) => EnquiryUpdateFormInputValues;
    onValidate?: EnquiryUpdateFormValidationValues;
} & React.CSSProperties>;
export default function EnquiryUpdateForm(props: EnquiryUpdateFormProps): React.ReactElement;
